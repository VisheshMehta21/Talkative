...
try {
    const res = await fetch(`${BASE_API_URL}/chats/individual`, {
        method:"POST",
        headers:{
...
export const createGroupChat = (chatData) => async (dispatch) => {
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/chats/group`, {
            ...
            body: formData,  // Send the FormData which includes the file and group data
        });
